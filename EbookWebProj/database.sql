...
UPDATE USERINFO
VALUES('user02', '010101', '박주희', 63, '010-5128-2241', '02-2|06-3|07-1', 0) WHERE USERID = 'user02';
UPDATE USERINFO
VALUES('user04', '010101', '고귀한', 41, '010-3015-1360', '01-1|08-3|10-2', 0) WHERE USERID = 'user04';
UPDATE USERINFO
VALUES('user05', '010101', '경주원', 30, '010-6398-5170', '04-3|07-1|09-2', 0) WHERE USERID = 'user05';
UPDATE USERINFO
VALUES('user06', '010101', '신지연', 44, '010-9834-1994', '03-1|06-1|10-2', 0) WHERE USERID = 'user06';
UPDATE USERINFO
VALUES('user07', '010101', '조윤희', 56, '010-8796-9198', '01-2|02-2|07-1', 0) WHERE USERID = 'user07';
UPDATE USERINFO
VALUES('user08', '010101', '신준상', 21, '010-2208-3498', '05-1|08-2|09-2', 0) WHERE USERID = 'user08'
UPDATE USERINFO
VALUES('user09', '010101', '변영호', 38, '010-8950-1290', '02-1|02-3|07-1', 0) WHERE USERID = 'user09';
UPDATE USERINFO
VALUES('user10', '010101', '이인엽', 27, '010-5097-9202', '03-3|05-2|09-2', 0) WHERE USERID = 'user10';
UPDATE USERINFO
VALUES('user12', '010101', '이복주', 58, '010-4553-9460', '02-1|07-2|10-3', 0) WHERE USERID = 'user12';
UPDATE USERINFO
VALUES('user13', '010101', '조혜민', 24, '010-8928-8190', '01-1|07-2|10-2', 0) WHERE USERID = 'user13';
UPDATE USERINFO
VALUES('user15', '010101', '오상준', 55, '010-2646-0988', '03-3|06-1|10-2', 0) WHERE USERID = 'user15';
UPDATE USERINFO
VALUES('user16', '010101', '이정아', 49, '010-9953-2818', '02-1|03-1|04-1', 0) WHERE USERID = 'user16'
UPDATE USERINFO
VALUES('user17', '010101', '차현경', 20, '010-9992-7668', '01-1|03-3|06-2', 0) WHERE USERID = 'user17';
UPDATE USERINFO
VALUES('user18', '010101', '이성표', 33, '010-4159-0784', '07-3|08-3|10-1', 0) WHERE USERID = 'user18';
UPDATE USERINFO
VALUES('user19', '010101', '김진한', 31, '010-4642-2087', '01-3|05-2|07-1', 0) WHERE USERID = 'user19';
UPDATE USERINFO
VALUES('user21', '010101', '한윤지', 45, '010-4366-1628', '01-2|02-2|07-1', 0) WHERE USERID = 'user21';
UPDATE USERINFO
VALUES('user22', '010101', '정지운', 33, '010-8883-6309', '03-3|06-2|08-3', 0) WHERE USERID = 'user22';
UPDATE USERINFO
VALUES('user23', '010101', '정찬호', 41, '010-3101-5939', '01-2|07-3|09-3', 0) WHERE USERID = 'user23';
UPDATE USERINFO
VALUES('user24', '010101', '이현빈', 32, '010-3826-1885', '07-1|08-2|10-3', 0) WHERE USERID = 'user24';
UPDATE USERINFO
VALUES('user25', '010101', '홍수현', 38, '010-2661-7544', '02-1|06-2|09-3', 0) WHERE USERID = 'user25';
UPDATE USERINFO
VALUES('user26', '010101', '김청아', 30, '010-4488-3846', '01-2|03-2|08-3', 0) WHERE USERID = 'user26';
UPDATE USERINFO
VALUES('user27', '010101', '이영호', 47, '010-9316-4625', '04-1|07-3|10-3', 0) WHERE USERID = 'user27';
UPDATE USERINFO
VALUES('user28', '010101', '장재호', 59, '010-6522-0139', '01-1|03-3|06-1', 0) WHERE USERID = 'user28';
UPDATE USERINFO
VALUES('user29', '010101', '최유리', 29, '010-9446-0858', '02-1|02-3|07-2', 0) WHERE USERID = 'user29';
UPDATE USERINFO
VALUES('user31', '010101', '함소연', 70, '010-7618-2215', '07-3|08-2|10-1', 0) WHERE USERID = 'user31';
UPDATE USERINFO
VALUES('user32', '010101', '이현우', 53, '010-4783-0627', '03-3|05-2|09-2', 0) WHERE USERID = 'user32';
